 ...
 * Read more http://webmar.com.au/blog/drupal-bootstrap-3-multilevel-submenus-hover
 */
function groupe_studyrama_menu_link(array $variables) {
 ...
 */
function groupe_studyrama_menu_link__book_toc(array $variables) {
  $element = $variables['element'];
  $sub_menu = drupal_render($element['#below']);
